        ...
        if len(parm) > 0:
            if parm.lower().startswith('http'):
                ...
                if len(url) > 0:
                    ...
                    self.response.out.write("<html><head><META HTTP-EQUIV=\"Refresh\" CONTENT=\"0;URL=" + url +
                                            "\"><META HTTP-EQUIV=\"Window-target\" CONTENT=\"_top\"><script type='text/javascript'>top.location.href='" + url + "';</script></head><body></body></html>")
                    return
                    # sys.exit(1)
